...
public class CachedHttpServletResponse extends HttpServletResponseWrapper{
    ...
    private CachedServletOutputStream out;           // response로 출력될 스트림
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        ...
        if(out == null){
            out = new CachedServletOutputStream(baos);
            System.out.println("create cachedOS");
        }
                    System.out.println("returned cachedOS");
